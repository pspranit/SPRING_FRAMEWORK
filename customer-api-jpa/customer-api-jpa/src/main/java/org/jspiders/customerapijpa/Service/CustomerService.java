package org.jspiders.customerapijpa.Service;

import org.jspiders.customerapijpa.Model.Customer;
import org.jspiders.customerapijpa.Repository.CustomerRepository;
...
public class CustomerService {
    ...
    public List<Customer> custTotalPurchaseLessThan(double total) {
        return repository.findByTotalPurchaseLessThan(total);
    }
...
//    //JPQL Start
    ...
    {
        return repository.viewCustomerByName(name);
    }
...
//    {
//        List<Customer> customerList= repository.displayAllCustomers();
//        return customerList;
//    }
